...
<section class="pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
  <div class="container-custom flex flex-col items-center text-center">
    ...
    <!-- Badge -->
    <a href="#" class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-purple-50 border border-purple-100 text-purple-600 text-xs font-medium mb-8 hover:bg-purple-100 transition-colors">
      Access 3M participants instantly • Results in 60 minutes
    ...
    <h1 class="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 mb-6 max-w-4xl mx-auto leading-[1.1]">
      Customer insights in <br class="hidden md:block" /> <span class="text-plain-green">hours, not weeks</span>
    </h1>

    <!-- Subheadline -->
    <p class="text-lg md:text-xl text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed">
      AI-powered research platform with instant participant access. Create studies in minutes, recruit from 3 million participants, and get AI-powered insights in hours.
    </p>

    <!-- Buttons -->
    <div class="flex flex-col sm:flex-row items-center gap-4 mb-20">
      <a href="#" class="px-6 py-3 text-sm font-bold bg-plain-green text-white rounded hover:opacity-90 transition-opacity uppercase tracking-wide shadow-sm shadow-purple-200">
                ...
                <div class="bg-[#1C1C1C] rounded-lg p-4 text-gray-300 shadow-xl border border-gray-800 max-w-2xl mx-auto mt-8">
                    <div class="flex items-center justify-between mb-4 border-b border-gray-700 pb-3">
                        <div class="flex items-center gap-2 text-xs font-medium text-gray-400">
                            <div class="w-4 h-4 rounded-full bg-plain-green flex items-center justify-center text-black font-bold">C</div>
                            Coach AI
                        </div>
                    ...
                    <div class="relative">
                        <input type="text" placeholder="Help me design my research study..." class="w-full bg-transparent border-none text-sm text-white placeholder-gray-500 focus:ring-0 p-0" />
